...
#define TPAD_ARR_MAX_VAL			65535		//65535
#define	TIMx_CAP_TIM_PSC			(6-1)		//以12M的频率计数,72MHz/6 = 12MHz来计数
...
#define TIMx_CAP_TIM_CHANNEL_x		TIM_Channel_2				//通道
...
#define TPAD_GATE_VAL				100		//阈值，需要和实际的开发板对应
///////////////////////////////////////
/* 外部变量申明区 */
