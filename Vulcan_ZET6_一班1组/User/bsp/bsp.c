...
//将bsp_timer里的延时再包装，共外部调用
/*
*********************************************************************************************************
*	函 数 名: delay_ms
*	功能说明: 将bsp_timer.c里的延时函数bsp_DelayMS再包装，供外部调用
*	形    参：见bsp_timer.c里的bsp_DelayMS
*	返 回 值: 无
*********************************************************************************************************
*/
...
*********************************************************************************************************
*	函 数 名: delay_us
*	功能说明: 将bsp_timer.c里的延时函数bsp_DelayUS再包装，供外部调用
*	形    参：见bsp_timer.c里的bsp_DelayUS
*	返 回 值: 无
*********************************************************************************************************
*/
...
void bsp_Init(void)
{
	...
	*/
	...
	//bsp_InitBeep();    /*配置BEEP端口*/
	
	bsp_InitKey();		/* 配置一下按键端口*/
	
	bsp_InitUart(115200);	/*配置串口1*/
	
	bsp_InitUart2(57600);	/*配置串口2*/
	
	bsp_InitUart4(115200);	/*配置串口4*/
