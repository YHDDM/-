...
/* 宏定义区域 */
//帧头
#define FRAME_HEADER_BYTE_1st		0x44//D固定帧头
#define FRAME_HEADER_BYTE_2nd		0x5A//Z固定帧头
#define FRAME_HEADER_BYTE_3rd		0x4C//L固定帧头
...
//RSP
#define FUN_CODE_RSP_RELAY_ON		0x00//继电器闭合
#define FUN_CODE_RSP_RELAY_OFF		0xFF//继电器断开

#define FUN_CODE_DECEIVE_FAN		0x02//风扇设备
#define FUN_CODE_CMD_FAN_ON			0x01//风扇开
#define FUN_CODE_CMD_FAN_OFF		0x02//风扇关
#define FUN_CODE_CMD_FAN_TOGGLE		0x03//风扇反转
#define FUN_CODE_CMD_FAN_QUERY		0x04//风扇状态查询
